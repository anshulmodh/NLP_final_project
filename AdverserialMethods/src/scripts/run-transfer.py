...
# TODO: try methods together; compute indicator words from hypothesis on label p(label given word); train model with some percentage of indicator words masked.
# Goal is to reduce probability of label given some indicator word
